...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("round1_model", sa.String(200), nullable=False, server_default="gemini-3.1-pro-preview"),
        ...
        sa.Column("round2_model", sa.String(200), nullable=False, server_default="gemini-3.1-pro-preview"),
